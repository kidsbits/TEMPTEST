...
1. Enter <https://microblocks.fun/> → Downloads.
2. Choose Windows / macOS / Linux package to download.  
3. Double-click the installation package and follow the wizard to complete the installation.
